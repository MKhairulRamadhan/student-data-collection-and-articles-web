		...
		<div class="row fullscreen d-flex align-items-center justify-content-between">
			<div class="banner-content col-lg-9 col-md-12">
				<h1 class="text-uppercase">
					Selamat Datang di SMAN 1 IDI RAYEUK KAB. ACEH TIMUR		
				</h1>
				<p class="pt-10 pb-10">
					Sekolah ini sedah berdiri sejak tahun 1960, saat ini dikepalai oleh pak husaini, SMAN 1 idi merupakan sekolah terbaik di kota idi rayeuk.
				</p>
				<a href="#" class="primary-btn text-uppercase">Jelajahi</a>
			</div>										
		</div>
	</div>					
</section>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="single-feature">
					<div class="title">
						<h4>No.1 of Senior HighSchool</h4>
					</div>
					<div class="desc-wrap">
						<p>
		...
		<div class="row d-flex justify-content-center">
			<div class="menu-content pb-70 col-lg-8">
				<div class="title text-center">
					...
					<p>In the history of modern Tech there is.</p>
				</div>
			</div>
		</div>					
		<div class="row">
			@foreach($posts as $post)
			<div class="col-lg-3 col-md-6 col-xs-1 single-blog" style="height:400px; margin-bottom:50px;">
				<div class="thumb">
					<img class="img-fluid" src="{{ $post->thumbnail()}}" alt="" style="position:relative;">								
				</div>
				...
				<a href="/{{$post->slug}}" class="details-btn d-flex justify-content-center align-items-center"><span class="details">Details</span><span class="lnr lnr-arrow-right"></span></a>		
			</div>
			@endforeach				
		</div>
	</div>	
